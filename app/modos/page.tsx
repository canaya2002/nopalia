...
export default function ModosPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-emerald-950 via-green-900 to-lime-900">
      ...
      <div className="flex-1 flex items-start justify-center px-4 sm:px-6 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 max-w-6xl w-full">
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-yellow-900/30 via-orange-900/25 to-amber-900/30 backdrop-blur-xl border border-yellow-400/30 rounded-xl overflow-hidden group-hover:border-yellow-400/50 transition-all duration-500 shadow-2xl">
              ...
              <div className="relative p-6 sm:p-8 border-b border-yellow-400/20">
                ...
                <div className="relative flex items-start justify-between mb-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <h2 className="text-2xl sm:text-3xl md:text-3xl font-black">
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-emerald-900/30 via-lime-900/25 to-cyan-900/30 backdrop-blur-xl border border-emerald-400/30 rounded-xl overflow-hidden group-hover:border-emerald-400/50 transition-all duration-500 shadow-2xl">
              ...
              {/* Header de la tarjeta con diseño mejorado */}
              <div className="relative p-6 sm:p-8 border-b border-emerald-400/20">
                {/* Patrón de fondo sutil */}
      ...
      <div className={`fixed bottom-6 left-1/2 transform -translate-x-1/2 transition-all duration-1000 z-10 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`} style={{animationDelay: '0.8s'}}>
        <button 
          onClick={() => router.back()}
